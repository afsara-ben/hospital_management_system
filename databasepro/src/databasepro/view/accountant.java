...
//    private  String em_email;
    ...
    public accountant(Integer em_id,String em_firstname,String em_lastname,String em_desig,String em_dob,String joining_date,Integer salary,String em_add,Integer em_contact,Integer job_id,Integer dept_id,String qualification)
    {
        super();
        this.em_id=em_id;
