...
public class pathologist {
    ...
    public pathologist(Integer em_id,String em_firstname,String em_lastname,String em_desig,String em_dob,String joining_date,Integer salary,String em_add,Integer em_contact,String em_email,Integer job_id,Integer dept_id,String qualification, Integer lab_no)
    {
        super();
        this.em_id=em_id;
