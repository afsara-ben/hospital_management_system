...
While Not myrs.EOF
Staff_id.AddItem (myrs!Staff_id)
myrs.MoveNext
Wend
myrs.Close
End Sub

Private Sub Staff_id_click()
myrs.Open "select * from staff_info where staff_id = '" & Staff_id.Text & "'", conn, adOpenKeyset, adLockOptimistic, -1
